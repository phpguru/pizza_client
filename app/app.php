            ...
            if (count($pizza_toppings)) {
                foreach ($pizza_toppings as $existing_topping) {
                    if ($possible_topping['name'] !== $existing_topping['name']) {
                        if(!in_array($possible_topping, $more_toppings)) {
                            if (!in_array(trim($possible_topping['name']), $de_dupe)) {
                                $possible_topping['name'] = ucwords(strtolower($possible_topping['name']));
                                $more_toppings[] = $possible_topping;
                                $de_dupe[] = trim($possible_topping['name']);
                            }
                        }
                    }
                }
